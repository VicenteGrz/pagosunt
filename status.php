					...
					<div class="card-body">
						<table class="table table-condensed table-bordered table-hover">
							...
							<tbody>
								<?php
								$i = 1;
								$student = $conn->query("SELECT * FROM status order by id_no asc ");
								...
								?>
									<tr>
										...
										<td class="">
											...
											<p>Whatsapp: <?php echo $row['wa'] ?></p>
											<p>Campus: <?php echo $row['plantel'] ?></p>
											<p>Pendientes: <?php echo $row['observaciones'] ?></p>
                                            <p>Status: <?php echo $row['observaciones'] ?></p>
