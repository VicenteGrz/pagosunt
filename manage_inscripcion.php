...
if (isset($_GET['id'])) {
    $qry = $conn->query("SELECT * FROM inscripcion where id= " . $_GET['id']);
    ...
    <div class="container-fluid">
        <form action="" id="manage-student">
            ...
            <div class="form-group">
                <label for="" class="control-label">Matricula</label>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="wa" value="<?php echo isset($wa) ? $wa : '' ?>" >
            </div>

            <div class="form-group">
                <label for="" class="control-label">Campus</label>
                <textarea name="address" id="" cols="30" rows="1" class="form-control" required><?php echo isset($address) ? $address : '' ?></textarea>
            </div>
            <div class="form-group">
                <label for="" class="control-label">Observaciones</label>
                <input type="text" class="form-control" name="observaciones" value="<?php echo isset($observaciones) ? $observaciones : '' ?>" >
            </div>
